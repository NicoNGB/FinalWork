...
def guardar_ticket(datos_usuario):
    ...
    try:
        font_codigo = ImageFont.truetype(font_path, 100)  # Tamaño de fuente 
        font_origen_destino = ImageFont.truetype(font_path, 100)  
        font_sillas = ImageFont.truetype(font_path, 100) 
        font_nombre = ImageFont.truetype(font_path, 100) 
        font_fecha_hora = ImageFont.truetype(font_path, 100)  
    except IOError:
